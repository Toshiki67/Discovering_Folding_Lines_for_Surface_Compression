...
class Meshes {
    public:
        ...
        // double weight_isometry = 800.0;//40.0
        // double weight_boundary = 800.0;//40.0
        // double weight_closeness = 50;// 1.0
        // double weight_angle = 32;
        // double weight_angle_sub = 1.25;
        // double weight_uniform = 1e-1 * 4.0;// 0.04
        // double weight_symmetric = 0.1;
        double weight_isometry = 40.0;
        double weight_boundary = 40.0;
        double weight_closeness = 1.0;
        double weight_angle = 32;
        double weight_angle_sub = 1.25;
        double weight_uniform = 0.04;
        double weight_symmetric = 0.1;
